...
> **目前版本：v0.7.5-alpha**（Phase 18C — Shared JSON Transaction Log I/O Extraction；詳見 [docs/RELEASE_NOTES.md](docs/RELEASE_NOTES.md) ｜ [docs/PROJECT_STATUS.md](docs/PROJECT_STATUS.md) ｜ [CHANGELOG.md](CHANGELOG.md)）
