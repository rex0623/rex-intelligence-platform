...
> **目前版本：v0.7.8-alpha**（Phase 19L — SQLite prune support；Phase 19J — migration script；Phase 19M Release Checkpoint Prepared；詳見 [docs/RELEASE_NOTES.md](docs/RELEASE_NOTES.md) ｜ [docs/PROJECT_STATUS.md](docs/PROJECT_STATUS.md) ｜ [CHANGELOG.md](CHANGELOG.md) ｜ [docs/OPERATOR_DEPLOYMENT.md](docs/OPERATOR_DEPLOYMENT.md)）
